...
// Upon click this should should trigger click on the #aulaVideo file input element
// This is better than showing the not-good-looking file input element
document.querySelector("#upload-button").addEventListener('click', function() {
	document.querySelector("#aulaVideo").click();
});

// When user chooses a MP4 file
document.querySelector("#aulaVideo").addEventListener('change', function() {
	// Validate whether MP4
    if(['video/mp4'].indexOf(document.querySelector("#aulaVideo").files[0].type) == -1) {
	...
	document.querySelector("#main-video source").setAttribute('src', URL.createObjectURL(document.querySelector("#aulaVideo").files[0]));
