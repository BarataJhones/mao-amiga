   ...
   <body class="bg-gray-100 tracking-wide bg-gray-200">
        <nav class="bg-white py-2 ">
            ...
            <div class="flex justify-between items-center">
                <a href="<?php echo e(config('laravel-erd.url')); ?>" class="font-bold text-xl text-indigo-600">ERD</a>
            </div>
      ...
      $(go.Link, // the whole link panel
          {
              ...
              reshapable: true,
              routing: go.Link.<?php echo e($routingType); ?>,
              corner: 5,
...
<?php /**PATH C:\xampp\htdocs\portao-mao-amigaLARAVEL\mao-amiga\vendor\kevincobain2000\laravel-erd\src\/../resources/views/index.blade.php ENDPATH**/ ?>