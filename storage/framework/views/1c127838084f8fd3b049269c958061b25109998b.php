<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('bootstrap/fontawesome.min.css')); ?>"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark static-top">
        <div class="container">
            <a class="navbar-brand video-popup" href="video/portal-mao-amiga.mp4">
                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo do Portal Mão Amiga">
                </a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('aula.listaIndex')); ?>">
                        <div class="col-padding text-uppercase text-warning icone">
                            <article class="borda">
                                <div class="icone-inicio"></div>
                                <a class="nav-link" href="<?php echo e(route('aula.listaIndex')); ?>">Início</span> 
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('aula.userList')); ?>">
                        <div class="col-padding text-uppercase text-warning icone">
                            <article class="borda">
                                <div class="icone-login"></div>
                                <a class="nav-link" href="<?php echo e(route('aula.userList')); ?>">Login</span> 
                            </article>
                        </div>
                    </a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\Portal Mão Amiga LARAVEL\mao-amiga\resources\views/telas/common/header.blade.php ENDPATH**/ ?>