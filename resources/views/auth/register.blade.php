    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form id="msform" method="POST" action="{{ route('register') }}">
                ...
                <!-- Email Address -->
                <fieldset>
                    <img class="form-gif" src="{{asset('img/form-sinais/gif_email.gif')}}" alt="Imagem animada com os sinais em LIBRAS para 'Email'"> <br>
                ...
                <!-- Gender -->
                <!-- <fieldset>
                    <img class="form-gif" src="{{asset('img/form-sinais/genero.jpg')}}" alt=""> <br>
                ...
                <!-- Institution -->
                <!-- <fieldset>
                    <img class="form-gif img-nascimento" src="{{asset('img/form-sinais/instituicao.jpg')}}" alt=""> <br>
                ...
                <!-- Grade -->
                <!-- <fieldset>
                    <img class="form-gif" src="{{asset('img/form-sinais/nivel.jpg')}}" alt=""> <br>
                ...
                <!-- Confirm Password -->
                <fieldset>
                    <img class="form-gif img-conf-senha" src="{{asset('img/form-sinais/gif_confirmar_senha.gif')}}" alt="Imagem animada com os sinais em LIBRAS para 'Confirme sua senha'"> <br>
